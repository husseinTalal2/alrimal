(async function () {
  ...
  const deleteProjectsBtns = document.getElementsByClassName("delete-project");
  const deleteMembersBtns = document.getElementsByClassName("delete-member");
  const deleteNewsBtns = document.getElementsByClassName("delete-item");
